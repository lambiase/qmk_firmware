...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = KEYMAP(DE_CIRC,KC_1,KC_2,KC_3,KC_4,KC_5,TG(2),KC_TAB,KC_Q,KC_W,KC_E,KC_R,KC_T,TG(1),CTL_T(KC_NO),KC_A,KC_S,KC_D,KC_F,KC_G,KC_LSHIFT,DE_Y,KC_X,KC_C,KC_V,KC_B,ALL_T(KC_NO),LT(1,KC_BSLASH),DE_LESS,LALT(KC_LSHIFT),ALT_T(KC_NO),CTL_T(KC_NO),ALT_T(KC_APPLICATION),KC_LGUI,KC_HOME,KC_BSPACE,KC_DELETE,KC_END,DE_ACUT,KC_6,KC_7,KC_8,KC_9,KC_0,DE_SS,TG(1),DE_Z,KC_U,KC_I,KC_O,KC_P,DE_UE,KC_H,KC_J,KC_K,KC_L,LT(1,DE_OE),GUI_T(DE_AE),ALGR_T(KC_NO),KC_N,KC_M,KC_COMMA,KC_DOT,RCTL_T(DE_MINS),KC_RSHIFT,KC_LEFT,KC_DOWN,KC_UP,KC_RIGHT,MO(1),KC_LALT,CTL_T(KC_ESCAPE),KC_PGUP,KC_PGDOWN,KC_ENTER,KC_SPACE),

  [1] = KEYMAP(KC_ESCAPE,KC_F1,KC_F2,KC_F3,KC_F4,KC_F5,KC_TRANSPARENT,KC_TRANSPARENT,KC_EXLM,KC_AT,KC_LCBR,KC_RCBR,KC_PIPE,KC_TRANSPARENT,KC_TRANSPARENT,KC_HASH,KC_DLR,KC_LPRN,KC_RPRN,KC_GRAVE,KC_TRANSPARENT,KC_PERC,KC_CIRC,KC_LBRACKET,KC_RBRACKET,KC_TILD,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,RGB_MOD,KC_TRANSPARENT,KC_TRANSPARENT,RGB_VAD,RGB_VAI,KC_TRANSPARENT,KC_TRANSPARENT,KC_F6,KC_F7,KC_F8,KC_F9,KC_F10,DE_ACUT,KC_TRANSPARENT,KC_UP,KC_7,KC_8,KC_9,KC_ASTR,DE_PLUS,KC_DOWN,KC_4,KC_5,KC_6,KC_TRANSPARENT,DE_HASH,KC_TRANSPARENT,KC_AMPR,KC_1,KC_2,KC_3,KC_BSLASH,KC_TRANSPARENT,KC_TRANSPARENT,KC_DOT,KC_0,KC_EQUAL,KC_TRANSPARENT,RGB_TOG,RGB_SLD,KC_TRANSPARENT,KC_TRANSPARENT,RGB_HUD,RGB_HUI),
